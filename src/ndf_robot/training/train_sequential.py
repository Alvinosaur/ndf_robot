...
# default experiment name as datetime string
default_exp_name = datetime.datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
p.add_argument('--experiment_name', type=str, default=default_exp_name,
